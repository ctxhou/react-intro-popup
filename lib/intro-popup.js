...
var IntroPopup = (function (_Component) {
  ...
  _createClass(IntroPopup, [{
    ...
    value: function handleLastBtn() {
      _reactDom2['default'].findDOMNode(this.refs['intro' + this.state.active]).style.display = 'none';
      var nextActive = this.state.active - 1;
      this.setState({
        active: nextActive
      }, function () {
        _reactDom2['default'].findDOMNode(this.refs['intro' + nextActive]).style.display = 'block';
      });
    }
  }, {
    key: 'handleNextBtn',
    ...
    value: function render() {
      ...
      var overlayClickClose = _props.overlayClickClose;
